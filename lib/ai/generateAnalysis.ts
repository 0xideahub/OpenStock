...
const FALLBACK_ANALYSIS =
  'Detailed growth-oriented analysis will appear here once AI integration is fully enabled. For now, rely on the fundamentals summary and key metrics above.';
